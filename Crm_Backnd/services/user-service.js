...
class UserService {
  ...
  verifyPassword = async (password, hashPassword) => {
    // plainPassword: what user typed
    // hashedPassword: what's stored in DB ($2b$10$...)
    console.log(bcrypt.compare(password, hashPassword),"bcrypt.compare(password, hashPassword)")
