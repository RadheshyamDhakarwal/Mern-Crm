...
router.post(
  "/view-assest-applications",
  asyncMiddleware(userController.viewAssestApplication)
);
router.post(
...
router.post(
  "/assign-employee-later",
  asyncMiddleware(userController.assignletter)
);
router.post(
...
router.post(
  "/update-assest/:id",
  asyncMiddleware(userController.updateAssestApplication)
);

// attendace
router.get(
  "/view-reception-attendance",
  asyncMiddleware(userController.getAllTodayInRequests)
);
router.post(
  "/view-reception-approve",
  asyncMiddleware(userController.approveInRequest)
);
router.post(
  "/all-regularize-request",
  asyncMiddleware(userController.getAllOutRegularizeRequests)
);
router.post(
